          ...
          <Container className="mx-auto py-10 px-6 max-w-[600px]">
            ...
            <Section className="mb-8">
              ...
              <Text className="text-darkText text-base leading-relaxed mb-4">
                ...
                <br />
                <strong>Monthly limit:</strong> {eventLimit > 0 ? `${eventLimit.toLocaleString()} events` : "No active subscription"}
              </Text>
              <Text className="text-darkText text-base leading-relaxed">
                {eventLimit > 0
                  ? "Your analytics tracking has been paused. To continue tracking events and accessing your analytics data, please upgrade your plan."
                  : "Your analytics tracking has been paused because your account has no active subscription. Subscribe to a plan to resume tracking."}
              </Text>
            </Section>
            ...
            <Section className="text-center border-t border-borderColor pt-5">
              <Text className="text-mutedText text-xs mb-2">
                Need help? Contact our support team at hello@eeseemetrics.com
              </Text>
