  ...
  return (
    <DisabledOverlay message="Goals" featurePath="goals" requiredPlan="basic">
      <div className="p-2 md:p-4 max-w-[1400px] mx-auto space-y-3">
        <SubHeader availableFilters={GOALS_PAGE_FILTERS} pageInfo="goals" />
        ...
        {isLoading || !site ? (
          ...
          <NothingFound
            ...
            description={<span>{t("Create your first conversion goal to start tracking important user actions.")} <Link href="https://docs.eeseemetrics.com/goals" className="text-blue-500 hover:underline" target="_blank">{t("Learn more")}</Link></span>}
