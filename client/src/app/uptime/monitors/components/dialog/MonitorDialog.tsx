...
export function MonitorDialog({ monitor, open, onOpenChange, siteId }: MonitorDialogProps) {
  ...
  // Set organization ID and siteId when active organization changes (create mode only)
  useEffect(() => {
  ...
  }, [activeOrganization, form, isEdit, siteId]);
