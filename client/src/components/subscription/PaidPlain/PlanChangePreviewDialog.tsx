            ...
            <div className="pt-1">
              ...
              {previewData.proration.credit > 0 && (
                <div className="flex justify-between text-sm mb-2">
                  ...
                  <span className="text-accent-400">-${previewData.proration.credit.toFixed(2)}</span>
                </div>
              )}

              <div className="flex justify-between text-sm font-medium pt-2">
                <span className="text-neutral-900 dark:text-neutral-100">Due now</span>
                <span className={previewData.proration.immediatePayment > 0 ? "text-neutral-900 dark:text-neutral-100" : "text-accent-400"}>
