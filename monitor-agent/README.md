# Eesee Metrics Monitor Agent

Regional monitoring agent for Eesee Metrics uptime monitoring system. This lightweight service runs on VPS instances in different regions to execute monitoring checks.
