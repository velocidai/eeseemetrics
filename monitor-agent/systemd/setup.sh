...
# Setup script for Eesee Monitor Agent with systemd
...
# Configuration
INSTALL_DIR="/opt/eesee-monitor-agent"
SERVICE_USER="eesee"
SERVICE_NAME="eesee-monitor-agent"
NODE_VERSION="20"
...
# Eesee Monitor Agent Configuration
NODE_ENV=production
PORT=3000
HOST=0.0.0.0
...
# Main Server
MAIN_SERVER_URL=https://your-eesee-server.com
...
cp eesee-monitor-agent.service /etc/systemd/system/
...
cat > /etc/logrotate.d/eesee-monitor-agent << EOF
...
if command -v ufw &> /dev/null; then
    ...
    ufw allow 3000/tcp comment "Eesee Monitor Agent"
fi
