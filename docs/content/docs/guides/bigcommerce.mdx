---
title: BigCommerce
description: Integrate eesee Analytics with your BigCommerce store
---
...
BigCommerce is a leading e-commerce platform for online stores. You can integrate eesee Analytics to track visitor behavior and conversions.

## How to Add eesee to BigCommerce

<Tabs items={['Script Manager (Recommended)', 'Theme Files']}>
<Tab>
### Using Script Manager

The easiest way to add eesee to BigCommerce is through the Script Manager.
...
- **Name**: eesee Analytics
- **Description**: eesee Analytics tracking script
- **Placement**: Head
- **Location**: All pages
...
To get the most out of eesee with BigCommerce, you can track key e-commerce events like product views and purchases.
...
<script>
(function() {
  function waitForeesee(callback, timeout) {
    var start = Date.now();
    (function check() {
