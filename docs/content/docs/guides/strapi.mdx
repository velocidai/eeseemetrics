---
title: Strapi
description: Integrate eesee Analytics with your Strapi-powered website
---

import { Callout } from 'fumadocs-ui/components/callout';

Strapi is an open-source headless CMS that provides an API for your content. Since Strapi is headless, you'll add eesee Analytics to your frontend application rather than to Strapi itself.
