---
title: Sanity
description: Integrate eesee Analytics with your Sanity-powered website
---

import { Callout } from 'fumadocs-ui/components/callout';

Sanity is a headless CMS that provides content management for your applications. Since Sanity is headless, you'll add eesee Analytics to your frontend application rather than to Sanity itself.
