---
title: Joomla
description: Integrate eesee Analytics with your Joomla website
---
...
Joomla is a popular open-source content management system. Here's how to add eesee Analytics to your Joomla site.

## How to Add eesee to Joomla
...
- **Title**: eesee Analytics (or any name you prefer)
- **Show Title**: No
