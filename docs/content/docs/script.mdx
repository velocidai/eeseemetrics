...
description: How to install and configure the eesee tracking script
---

import { Callout } from 'fumadocs-ui/components/callout';

To start tracking user activity on your website, add the eesee tracking script to your site's HTML.
...
```html
<script src="https://app.eeseemetrics.com/api/script.js" async data-site-id="YOUR_SITE_ID"></script>
```
If you are self-hosting eesee `app.eesee.io` will be domain of your eesee instance.
...
Most tracking options are configured through your site settings in the eesee dashboard. The script automatically fetches these settings when it loads:
