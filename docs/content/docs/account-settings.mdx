...
Generate API keys to access eesee's analytics endpoints from your applications.
...
Include your API key in requests to eesee's API endpoints. See the [API documentation](/docs/api) for available endpoints and usage examples.
