...
export async function generateMetadata(props: { params: Promise<{ slug: string[] }> }): Promise<Metadata> {
  ...
  const url = `https://eeseemetrics.com/blog/${params.slug.join("/")}`;
  ...
  return {
    ...
    twitter: {
      ...
      description: page.data.description,
      images: [ogImage],
      creator: "@eeseemetrics",
    },
    keywords: page.data.tags
      ? [...page.data.tags, "web analytics", "privacy analytics", "Eesee Metrics"]
      : ["web analytics", "privacy analytics", "Eesee Metrics"],
...
export default async function BlogPostPage(props: { params: Promise<{ slug: string[] }> }) {
  ...
  const structuredData = {
    ...
    publisher: {
      ...
      logo: {
        "@type": "ImageObject",
        url: "https://eeseemetrics.com/icon.svg",
      },
    },
