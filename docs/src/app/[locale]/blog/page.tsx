...
export const metadata: Metadata = {
  title: "Blog",
  description: "Guides, tutorials, and insights on privacy-first web analytics, GDPR compliance, AI-powered reporting, and growing your site without tracking your users.",
};
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-16">
      <div className="mb-12">
        ...
        <p className="text-xl text-neutral-600 dark:text-neutral-400">Latest updates, tutorials, and insights from the Eesee Metrics team</p>
      </div>
            ...
            <Link key={post.slugs.join("/")} href={`/blog/${post.slugs.join("/")}`} className="group">
              <article className="h-full bg-neutral-100 dark:bg-neutral-900 rounded-lg border border-neutral-300 dark:border-neutral-800 p-6 hover:border-neutral-400 dark:hover:border-neutral-700 transition-all hover:-translate-y-1">
                ...
                <div className="flex flex-col h-full">
                  <h2 className="text-xl font-semibold mb-2 group-hover:text-[#26B0A2] dark:group-hover:text-[#2FC7B8] transition-colors">
                    {post.data.title}
                  </h2>
