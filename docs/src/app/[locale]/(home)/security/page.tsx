...
export const metadata = createMetadata({
  title: "Security",
  description: "Eesee Metrics security practices and data protection",
  openGraph: {
    images: [createOGImageUrl("Security", "Eesee Metrics security practices and data protection")],
  },
  twitter: {
    images: [createOGImageUrl("Security", "Eesee Metrics security practices and data protection")],
  },
    ...
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="prose prose-invert max-w-none">
        <p className="text-lg mb-8">
          Security and privacy are at the core of everything we do at Eesee Metrics. Here's how we protect your data and
        ...
        <p>
          Eesee Metrics is hosted on Hetzner servers located in Germany, within the European Union. Hetzner is ISO 27001
        ...
        <p>Eesee Metrics is fully open source (AGPL-3.0), which means:</p>
        <ul className="list-disc pl-6 space-y-2">
          <li>
            Our entire codebase is{" "}
            <a href="https://github.com/velocidai/eeseemetrics" target="_blank" rel="noopener noreferrer" className="text-[#2FC7B8] hover:text-[#2FC7B8]/80">
        ...
        <p>Eesee Metrics is designed to help you comply with privacy regulations:</p>
        <ul className="list-disc pl-6 space-y-2">
        ...
        <p>If you discover a security vulnerability in Eesee Metrics, please report it responsibly:</p>
        <ul className="list-disc pl-6 space-y-2">
          <li>
            Email us at{" "}
