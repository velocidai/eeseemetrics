...
export const metadata = createMetadata({
  ...
  description: "Eesee Metrics terms and conditions of service",
  openGraph: {
    images: [createOGImageUrl("Terms and Conditions", "Eesee Metrics terms and conditions of service")],
  },
  twitter: {
    images: [createOGImageUrl("Terms and Conditions", "Eesee Metrics terms and conditions of service")],
  },
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="prose prose-invert max-w-none">
        ...
        <p>
          By accessing and using Eesee Metrics, you accept and agree to be bound by the terms and provision of this agreement.
          If you do not agree to these terms, please do not use our service.
        </p>

        <h2 className="text-2xl font-semibold mt-8 mb-4">Description of Service</h2>
        <p>
          Eesee Metrics is an open-source, privacy-friendly web analytics platform. We provide both a cloud-hosted service and
        ...
        <p>You agree to use Eesee Metrics only for lawful purposes and in accordance with these Terms. You agree not to:</p>
        ...
        <p>
          Eesee Metrics is open-source software released under the AGPL 3.0 License. The self-hosted version is free to use, modify,
        ...
        <p>
          Eesee Metrics does not collect personally identifiable information from your website visitors. Our service is
          ...
          <a href="/privacy" className="text-[#2FC7B8] hover:text-[#2FC7B8]/80 mx-1">
            Privacy Policy
          </a>
          .
        </p>
        ...
        <p>
          You are responsible for ensuring your use of Eesee Metrics complies with all applicable privacy laws and regulations
          in your jurisdiction. You must obtain any necessary consents from your website visitors as required by law.
        </p>

        <h2 className="text-2xl font-semibold mt-8 mb-4">Intellectual Property</h2>
        <p>
          The Eesee Metrics name, logo, and branding are property of Eesee Metrics. The open-source code is available under the AGPL 3.0
        ...
        <p>
          To the maximum extent permitted by law, Eesee Metrics and its contributors shall not be liable for any indirect,
        ...
        <p>
          You agree to indemnify and hold harmless Eesee Metrics and its contributors from any claims, damages, losses,
        ...
        <p>
          These Terms, along with our Privacy Policy, constitute the entire agreement between you and Eesee Metrics regarding
        ...
        <p>
          ...
          <a href="https://eeseemetrics.com/contact" className="text-[#2FC7B8] hover:text-[#2FC7B8]/80 ml-1">
