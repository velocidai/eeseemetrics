...
export const metadata = {
  title: "Free Marketing Tools | Eesee Metrics",
  description:
...
function ToolCard({ tool }: { tool: { href: string; icon: any; title: string; description: string } }) {
  ...
  return (
    <Link
      href={tool.href}
      className="group bg-white/50 dark:bg-neutral-900/50 border border-neutral-200 dark:border-neutral-800 rounded-xl p-6 transition-all hover:border-[#2FC7B8]/40 dark:hover:border-[#2FC7B8]/30 hover:-translate-y-1 duration-300"
    >
      <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#2FC7B8]/20 to-[#26B0A2]/10 dark:from-[#2FC7B8]/15 dark:to-[#26B0A2]/8 border border-[#2FC7B8]/40 dark:border-[#2FC7B8]/30 shadow-md shadow-[#2FC7B8]/10 dark:shadow-[#2FC7B8]/10 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
        <Icon className="w-6 h-6 text-[#26B0A2] dark:text-[#2FC7B8]" />
      </div>
      ...
      <div className="flex items-center text-[#26B0A2] dark:text-[#2FC7B8] text-sm font-medium group-hover:translate-x-1 transition-transform duration-300">
        Try it now →
      </div>
    </Link>
  );
      ...
      <div className="max-w-[1200px] mx-auto px-6 py-20">
        ...
        <div className="mb-16">
          <div className="flex items-center gap-3 mb-8">
            <Calculator className="w-6 h-6 text-[#26B0A2] dark:text-[#2FC7B8]" />
        ...
        <div className="mb-16">
          <div className="flex items-center gap-3 mb-8">
            <Sparkles className="w-6 h-6 text-[#26B0A2] dark:text-[#2FC7B8]" />
        ...
        <div className="mb-16">
          <div className="flex items-center gap-3 mb-8">
            <MessageCircle className="w-6 h-6 text-[#26B0A2] dark:text-[#2FC7B8]" />
        ...
        <div>
          <div className="flex items-center gap-3 mb-8">
            <Activity className="w-6 h-6 text-[#26B0A2] dark:text-[#2FC7B8]" />
